...
before(function(){
    ...
    it('Check search results by data-category', function(){
        ...
        driver.get("https://xn--80ae2aeeogi5fxc.xn--p1ai/").then(function() {
           ...
           return  x = driver.findElement(By.css('div.product_row:first-child')).getAttribute('data-category').then(res =>{
           ...
           console.log('Searched element is: ' + searchedItem);
            ...
            driver.findElements(By.css('div.product_row')).then(function(elements){
                elements.map(function(elem){
                    elem.getAttribute('data-category').then(function(txt){     
